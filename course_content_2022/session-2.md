...
### Videos
* [2 - Visualization Design](https://youtube.com/playlist?list=PLk8hZQByYcuC7Aq86Xg9DN1271hsJW266)

### Videos (Color - extra)
* [2e - Color for DataVis](https://youtube.com/playlist?list=PLk8hZQByYcuCbpHCAWmjWyWP7BpTV7cCW)

### Videos (Sketching - extra)
* [2e - Sketching](https://youtu.be/zaWquoSD_NQ)
...
1. Activity 1 (3min)
    * ***On your own***
    * Using plain paper or a tablet, design as many different visualisations that you can think of to represent or communicate the two numbers provided.
...
1. Activity 2 (3min)
    * ***As a group***
    * Based on additional context - the meaning of the numbers, repeat exercise.  
  You may draw on the whiteboard (in the Teams channel) or share another drawing app from any participant's computer.
...
Tutorial introduction [video on sketching](https://youtu.be/zaWquoSD_NQ) and [slides](files/2-Sketching.pdf).


1. Discussion 1 (30 min)
    * **In the main classroom** (10 min)
...
__NOTE: no need to share sensitive data, especially when making annotations - your design need not be this specific__<br /><br />
1. Discussion 2 (15 min)
    ...
    * Nominate one idea or set of related ideas to discuss in class<br /><br />
1. Activity 2 (15 min)
    * ***On your own***
    ...
    * Now consider more practical considerations that may impact what of your design you can deliver now
        ...
        * note any practical constraints you envisage, e.g., (course) length and other resources needed to build solution, including technical skills, target user context and capability -
            ...
            - what can be set as future work, that will further enhance your initial delivery?<br /><br />
1. Discussion 3 (10 min)
    * **In the main classroom**
    - Round table discussion
    - General class feedback
    - Brief summary of reflection exercise, submission requirements and due date (Jun 12th)
   <br />    

___Before submission &ndash; reflect on your design choices by revisiting the [guidelines](#general-guidelines) for this exercise___
